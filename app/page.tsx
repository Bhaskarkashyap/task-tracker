   ...
   <div className="min-h-screen ">
      <header className="px-4 lg:px-6 h-14 flex items-center border-b">
        <Link className="flex items-center justify-center" href="/">
          <span className="font-bold text-xl">Taskpur</span>
        </Link>
       ...
       <main className="flex justify-center w-full items-center">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 flex justify-center">
          <div className="container px-4 md:px-6">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-7xl max-w-5xl ">
  <span className=" ">
    ...
    Track your projects and tasks in one place. Stay organized and boost your productivity.
      </p>
    </div>
